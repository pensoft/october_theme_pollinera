...
$(document).ready(function() {
    ...
    $('.work_packages .accordion-content, .getinvolved_form_accordion .accordion-toggle').each(function( index, value ) {
    ...
    $('<div class="col-xs-12 col-sm-3 card internal no-border" style="margin-bottom: 15px">\n' +
        '<a class="folder-background" style="display:flex; background: url(https://pollinera.eu/storage/app/media/working-documents-live.svg) center center no-repeat; background-size: 100px; height: 200px" href="/internal-repository/living-documents" title="Working documents (live)"></a>\n' +
    ...
    $('<div class="col-xs-12 col-sm-3 card internal no-border" style="margin-bottom: 15px">\n' +
        '<a class="folder-background" style="display:flex; background: url(https://pollinera.eu/storage/app/media/Reporting%20forms.svg) center center no-repeat; background-size: 100px; height: 200px" href="/internal-repository/forms" title="Reporting forms"></a>\n' +
